...
os.mkdir("/Users/sam/Downloads/scenario3C")

#to download the text from url
url_of_content="http://webservices.ingv.it/fdsnws/event/1/query?starttime=1985-01-01T00%3A00%3A00&endtime=2021-06-30T23%3A59%3A59&minmag=6&maxmag=10&mindepth=-10&maxdepth=1000&minlat=27&maxlat=48&minlon=-7&maxlon=37.5&minversion=100&orderby=time-asc&format=text&limit=10000"
urllib.request.urlretrieve(url_of_content,"/Users/sam/Downloads/scenario3C/test.txt")

#to write as csv
df = pd.read_fwf("/Users/sam/Downloads/scenario3C/test.txt")
df.to_csv("/Users/sam/Downloads/scenario3C/test.csv", index=False)
#to cleann the downloaed file
with open ("/Users/sam/Downloads/scenario3C/test.csv","r") as file1, open ("/Users/sam/Downloads/scenario3C/test_1.csv","w") as file2:
    content1 = file1.read()
...
df = pd.read_csv("/Users/sam/Downloads/scenario3C/test_1.csv")
...
df.to_csv("/Users/sam/Downloads/scenario3C/ro_create.csv", index=False)
...
with open("/Users/sam/Downloads/scenario3C/test_ro.csv", "w") as f:
    write = csv.writer(f)
    write.writerow(l)
with open ("/Users/sam/Downloads/scenario3C/test_ro.csv","r") as file1, open ("/Users/sam/Downloads/scenario3C/test_ro_1.csv","w") as file2:
    content1 = file1.read()
    content2 = content1.replace("Research Object with ID: ", "")
    file2.write(content2)

df = pd.read_csv("/Users/sam/Downloads/scenario3C/test_ro_1.csv")
df = df.T
df.to_csv("/Users/sam/Downloads/scenario3C/test_ro_1.csv")
df = pd.read_csv("/Users/sam/Downloads/scenario3C/test_ro_1.csv")
#header= ["identifier"]
df.to_csv("/Users/sam/Downloads/scenario3C/test_ro_1.csv", header=["identifier"], index=False)
#df = pd.read_csv("/Users/sam/Downloads/scenario3C/test_ro_2.csv")

df = pd.read_csv("/Users/sam/Downloads/scenario3C/ro_create.csv")
df1= pd.read_csv("/Users/sam/Downloads/scenario3C/test_ro_1.csv", usecols = ['identifier'])
...
os.mkdir("/Users/sam/Downloads/scenario3C/Test_geojson")
for (x,y,z) in zip(s,t,w):
    ...
    with open(f"/Users/sam/Downloads/scenario3C/Test_geojson/{z}.json", "w") as fp:
        json.dump(geojson, fp)

geolocation=[rohub.ros_add_geolocation(identifier=x, body_specification_json=f"/Users/sam/Downloads/scenario3C/Test_geojson/{y}.json") for (x,y) in zip (u,w)]
...
os.mkdir("/Users/sam/Downloads/scenario3C/Test_sketch")
df= pd.read_csv("/Users/sam/Downloads/scenario3C/ro_create.csv")
s=list(df["Latitude"])
t=list(df["Longitude"])
u=list(df["EventID"])
for (x,y,z) in zip(s,t,u):
    ...
    #fig.show()
    fig.write_image(f"/Users/sam/Downloads/scenario3C/Test_sketch/{z}.png")

#to add sketch
df =pd.read_csv("/Users/sam/Downloads/scenario3C/ro_create.csv")
s=list(df["identifier"])
t=list(df["EventID"])
sketch=[rohub.ros_add_internal_resource(identifier=x, res_type="Sketch", file_path=f"/Users/sam/Downloads/scenario3C/Test_sketch/{y}.png") for (x,y) in zip(s,t)]
...
#os.remove("/Users/sam/Downloads/scenario3C/test.txt")
os.remove("/Users/sam/Downloads/scenario3C/test.csv")
os.remove("/Users/sam/Downloads/scenario3C/test_1.csv")
os.remove("/Users/sam/Downloads/scenario3C/test_ro.csv")
os.remove("/Users/sam/Downloads/scenario3C/test_ro_1.csv")
